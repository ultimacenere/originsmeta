              ...
              return (
                <li key={deck.id} className="card-ivory flex flex-col p-5">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="stat-pill border border-sky text-ink">{archetypeLabels[deck.archetype]?.[locale] ?? deck.archetype}</span>
                  ...
                  <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-sky pt-3">
                    ...
                    <Link href={`${viewHref}/edit`} className="btn border border-sky text-xs text-ink">
                      {c.edit}
                    </Link>
