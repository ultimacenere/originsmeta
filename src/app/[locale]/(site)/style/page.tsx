      ...
      <section id="postits" className="mt-16 scroll-mt-24">
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="grid gap-6">
            ...
            <div className="strip-labeled card-night flex flex-wrap items-center gap-4">
              <p className="strip-postit strip-postit-mint strip-postit-bang strip-postit-doodle" style={{ ["--tilt" as string]: "4deg", ["--scrawl" as string]: "-1.5deg" } as React.CSSProperties}>
