          ...
          <section className="card-ivory flex flex-col p-5">
            ...
            <ul className="mt-4 space-y-2">
              {tierList.sections.map((s) => {
                ...
                return (
                  <li key={s.id}>
                    <Link href={href(locale, `/tier-list#${s.id}`)} className="block rounded-lg border border-sky px-3 py-2 hover:bg-ink hover:text-ivory">
            ...
            <li key={deck.slug}>
              <Link href={href(locale, `/decks/${deck.slug}`)} className="card-ivory card-ivory-hover flex h-full flex-col p-5">
                <span className="flex flex-wrap gap-2">
                  ...
                  <span className="stat-pill border border-sky text-ink">{archetypeLabels[deck.archetype][locale]}</span>
                </span>
