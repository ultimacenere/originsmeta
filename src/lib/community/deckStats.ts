 ...
 * solo e GA4/Vercel restano come prima. Dall'unione con il pacchetto VIDEO (26/09/2026) anche il clic su "riproduci"
 * del lettore a clic della scheda (`video_play` con placement `deck_page`, mandato da VideoEmbed): il primo clic è sul
