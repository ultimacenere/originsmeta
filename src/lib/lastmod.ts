...
export const PAGE_UPDATED = {
  ...
  "/decks/community/[slug]": "2026-09-26", // pacchetto STREAM: menu "Per le dirette" e og:image dalla lista del mazzo; Ondata 2: soglia di qualità, JSON-LD di autore e carte, altri mazzi per Leggendaria
