  ...
  return (
    <section className="mt-8" aria-labelledby="deck-stats-title">
      ...
      <div className="mt-3 grid gap-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <figure className="rounded-xl border border-ink/15 bg-ivory-2/60 p-4">
          <figcaption className="flex flex-wrap items-center justify-between gap-2">
            ...
            <span className="flex flex-wrap gap-3 font-mono text-[11px] text-ink-muted">
              ...
              {stats.legendaryCost !== null ? (
                <span className="inline-flex items-center gap-1">
                  <i className="inline-block h-2.5 w-2.5 rounded-sm border border-ink/40" style={{ background: C.legendary }} /> {labels.legendary}
                </span>
              ) : null}
            </span>
          </figcaption>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <figure className="col-span-2 flex items-center gap-4 rounded-xl border border-ink/15 bg-ivory-2/60 p-4">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <div className="grid gap-4">
          ...
          <div className="flex items-center justify-between gap-3 rounded-xl border border-dashed border-ink/25 p-4">
            <div>
...
function Tile({ label, value, hint }: { label: string; value: string; hint?: string }) {
  return (
    <div className="rounded-xl border border-ink/15 bg-ivory-2/60 p-4">
