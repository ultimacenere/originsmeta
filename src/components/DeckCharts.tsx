  ...
  return (
    <section className="mt-8" aria-labelledby="deck-stats-title">
      <div className="flex flex-wrap items-end justify-between gap-2">
        <h2 id="deck-stats-title" className="text-xl font-extrabold text-mint">
          {labels.title}
        </h2>
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        ...
        <div className="grid gap-4">
          ...
          <div className="flex items-center justify-between gap-3 rounded-xl border border-dashed border-sky p-4">
            <div>
              <p className="kicker text-pale-muted">{labels.winrate}</p>
              <p className="mt-1 font-display text-2xl font-extrabold text-mint/40">–</p>
            </div>
...
function Tile({ label, value, hint }: { label: string; value: string; hint?: string }) {
  return (
    <div className="rounded-xl border border-sky bg-night-2/60 p-4">
      ...
      <p className="mt-1 font-display text-2xl font-extrabold leading-none text-mint tabular-nums">{value}</p>
