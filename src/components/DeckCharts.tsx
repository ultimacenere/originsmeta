  ...
  return (
    <section className="mt-8" aria-labelledby="deck-stats-title">
      ...
      <div className="mt-3 grid gap-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <figure className="rounded-xl border border-sky bg-ivory-2/60 p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <figure className="col-span-2 flex items-center gap-4 rounded-xl border border-sky bg-ivory-2/60 p-4">
...
function Tile({ label, value, hint }: { label: string; value: string; hint?: string }) {
  return (
    <div className="rounded-xl border border-sky bg-ivory-2/60 p-4">
