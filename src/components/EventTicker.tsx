...
export function EventTicker({ locale, dict }: { locale: Locale; dict: Dictionary }) {
  ...
  return <TickerMarquee items={items} ariaLabel={dict.common.calendar} nextLabel={dict.common.next} prevLabel={dict.common.scrollLeft} nextBtnLabel={dict.common.scrollRight} />;
}
