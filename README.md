...
- **Fasi successive**: tabellone e pagina di gestione (`/manage`: avvio con bye, seeding casuale o manuale, scambi, override, abbandoni), stanza partita (chat tra i due giocatori, referto Bo con doppia conferma, screenshot), deck builder dedicato al torneo, tornei `listed` nella striscia del calendario (`/api/calendar`).
