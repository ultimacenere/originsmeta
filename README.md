...
- **Fasi successive**: stanza partita (`/match/[id]`: chat tra i due giocatori, referto con doppia conferma, screenshot privati), deck builder dedicato al torneo, tornei `listed` nella striscia del calendario (`/api/calendar`).
