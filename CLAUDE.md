...
- Tasti verso Steam e Discord: sempre `SteamButton`/`DiscordButton` (colori e font ufficiali, richiesta esplicita di Pierluigi). Bianchi: avorio (`ivory` #f7f1e4, `chalk` #f3eee0 per il testo chiaro e il logo). Cornici degli elementi avorio: celeste pieno da 3 px (`sky` #3fc4e8, il cristallo del mana; 2 px su chip e cubi data, 6 px sullo slider), niente righette sottili. Provata e scartata il 15/09/2026 la versione "notte" (schede scure come MetaShift): Pierluigi è tornato all'avorio tenendo solo le cornici.
